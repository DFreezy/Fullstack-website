                ...
                <div className="flex flex-wrap justify-evenly">
                    <div className='bg-slate-300 py-4 px-6 cursor-pointer flex flex-col items-center max-w-sm'>
                        ...
                        <p className="text-sm break-words">
                            The choice between Bootstrap and Tailwind CSS often depends on project requirements and personal preference. If you want to quickly create a functional, consistent design with minimal effort, Bootstrap might be the way to go. If you prefer a more flexible and customizable approach that allows for unique designs, Tailwind CSS is an excellent choice.
                        </p>
                    ...
                    <div className='bg-slate-300 py-4 px-6 cursor-pointer flex flex-col items-center max-w-sm'>
                        ...
                        <p>Deciding between getting a website or an app can be decision that might impact your budget, but also the potential growth your bussiness could see
                            Let's not forget about the SEO ranking as well
                        </p>
                        <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors duration-200">See more</button>
                    </div>
...
Improving your site's ranking in search engine results (SEO) involves various strategies and techniques. Here are some key approaches you can take:

Keyword Research
Identify relevant keywords that your target audience is searching for.
Use tools like Google Keyword Planner, Ahrefs, or SEMrush to find high-traffic keywords.
                        </p>
                        <button className="mt-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition-colors duration-200">See more</button>
                    </div>
                </div>
                <div className='flex items-center justify-center'>
                <button className='mt-2 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition-colors duration-200'>See all posts</button>
                </div>
            </div>
        </>
    );
